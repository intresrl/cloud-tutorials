package it.intre.booktophrases.batchprocess.examples;
 ...
 * </pre>
 *
 * <p>No arguments are required to run this pipeline. It will be executed with the DirectRunner.
 * You can see the results in the output files in your current working directory, with names like
